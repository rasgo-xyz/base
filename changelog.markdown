...
- Removed Styleguide
- Minor update in less structure
- Moved _helpers.less into styles.less
- Version bump for style.less, package.json and bower.json
...
- Fixed broken mixins, media queries and non-responsive grid
- Version bump for style.less, package.json and bower.json
